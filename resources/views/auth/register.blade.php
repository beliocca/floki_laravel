      ...
      <div class="register">
          ...
          <article class="art2">
              <form class="formulario-registro" action="{{ route('register') }}" method="post">
                  ...
                  <p>
                    <input id="name" type="text" class="userform" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus
                            @error('name')
                              @if (isset($message))
                               placeholder="{{ $message }}"
                           @enderror
                  ...
                  <p>
                    <input id="last_name" type="text" class="userform" name="last_name" value="{{ old('last_name') }}"  autocomplete="last_name" autofocus
                            @error('last_name')
                              @if (isset($message))
                               placeholder="{{ $message }}"
                           @enderror
                  ...
                  <p>
                    <input id="email" type="text" class="userform" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus
                            @error('email')
                              @if (isset($message))
                               placeholder="{{ $message }}"
                           @enderror
                  ...
                  <p>
                    <input id="password-confirm" type="password" class="userform" name="password-confirmation"  autocomplete="new-password"
                  ...
                  <p>
                      ...
                      <div><input class="tyc" type="checkbox" name="newsletter" value= 1>
                          Deseo recibir novedades en mi email.</div>
                      <div>

                        <input id="tyc" type="checkbox" class="tyc" name="tyc">
